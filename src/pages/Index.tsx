  ...
  return (
    <div className="min-h-screen bg-[#fcfcfc]">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-sm bg-white/80 border-b">
        <div className="container mx-auto flex justify-between items-center p-4">
          ...
          <nav className="hidden md:flex gap-8">
            <a href="#about" className="hover:text-[#9b87f5] transition-colors">О школе</a>
            <a href="#teachers" className="hover:text-[#9b87f5] transition-colors">Преподаватели</a>
            <a href="#programs" className="hover:text-[#9b87f5] transition-colors">Программы</a>
            <a href="#testimonials" className="hover:text-[#9b87f5] transition-colors">Отзывы</a>
          </nav>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl text-white">
            ...
            <p className="text-lg md:text-xl mb-8">
              Занятия с сертифицированными преподавателями, которые помогут вам достичь гармонии тела и разума
            </p>
      ...
      <section id="about" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-montserrat text-3xl md:text-4xl font-bold mb-4">О нашей школе</h2>
            <div className="w-20 h-1 bg-[#9b87f5] mx-auto mb-8"></div>
            <p className="max-w-3xl mx-auto text-lg text-gray-600">
              "Гармония" - это пространство, где мы объединяем тысячелетние традиции йоги с современными методиками, чтобы помочь вам найти баланс в жизни.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 hover-scale transition-all">
              ...
              <h3 className="font-montserrat text-xl font-semibold mb-3">Наша миссия</h3>
              <p className="text-gray-600">
                Сделать практику йоги доступной для каждого, независимо от возраста и уровня подготовки.
              </p>
            </div>
            ...
            <div className="text-center p-6 hover-scale transition-all">
              ...
              <h3 className="font-montserrat text-xl font-semibold mb-3">Наш подход</h3>
              <p className="text-gray-600">
                Индивидуальное внимание к каждому ученику с фокусом на правильной технике выполнения.
              </p>
            </div>
            ...
            <div className="text-center p-6 hover-scale transition-all">
              ...
              <h3 className="font-montserrat text-xl font-semibold mb-3">Наши ценности</h3>
              <p className="text-gray-600">
                Уважение к традициям, внимательность, поддержка и непрерывное развитие.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="teachers" className="py-20 bg-[#f9f9ff]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-montserrat text-3xl md:text-4xl font-bold mb-4">Наши преподаватели</h2>
            <div className="w-20 h-1 bg-[#9b87f5] mx-auto mb-8"></div>
            <p className="max-w-3xl mx-auto text-lg text-gray-600">
              Обучение проводят сертифицированные преподаватели с многолетним опытом практики и преподавания.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="overflow-hidden hover:shadow-lg transition-all">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Сертифицированный преподаватель с 10-летним опытом. Прошла обучение в Индии и США.
                </p>
                <div className="flex gap-2 flex-wrap">
                  <span className="bg-[#F2FCE2] text-sm py-1 px-3 rounded-full">RYT-500</span>
                  <span className="bg-[#FEF7CD] text-sm py-1 px-3 rounded-full">Йогатерапия</span>
                  <span className="bg-[#E5DEFF] text-sm py-1 px-3 rounded-full">Пранаяма</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-all">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Практикует йогу более 15 лет. Специализируется на работе с энергетическими практиками.
                </p>
                <div className="flex gap-2 flex-wrap">
                  <span className="bg-[#F2FCE2] text-sm py-1 px-3 rounded-full">IKYTA</span>
                  <span className="bg-[#FEF7CD] text-sm py-1 px-3 rounded-full">Медитация</span>
                  <span className="bg-[#E5DEFF] text-sm py-1 px-3 rounded-full">Аюрведа</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-all">
              ...
              <CardHeader>
                ...
                <CardDescription>Виньяса-флоу, Йога для беременных</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Преподаватель с медицинским образованием. Специализируется на адаптивной йоге.
                </p>
                <div className="flex gap-2 flex-wrap">
                  <span className="bg-[#F2FCE2] text-sm py-1 px-3 rounded-full">RYT-200</span>
                  <span className="bg-[#FEF7CD] text-sm py-1 px-3 rounded-full">Пренатальная йога</span>
                  <span className="bg-[#E5DEFF] text-sm py-1 px-3 rounded-full">Реабилитация</span>
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      <section id="programs" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-montserrat text-3xl md:text-4xl font-bold mb-4">Наши программы</h2>
            <div className="w-20 h-1 bg-[#9b87f5] mx-auto mb-8"></div>
            <p className="max-w-3xl mx-auto text-lg text-gray-600">
              Мы предлагаем разнообразные направления йоги для любого уровня подготовки и целей.
            </p>
          </div>
      ...
      <section id="testimonials" className="py-20 bg-[#f9f9ff]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-montserrat text-3xl md:text-4xl font-bold mb-4">Отзывы о нас</h2>
            <div className="w-20 h-1 bg-[#9b87f5] mx-auto mb-8"></div>
            <p className="max-w-3xl mx-auto text-lg text-gray-600">
              ...
              <CarouselItem>
                <div className="p-6">
                  <div className="bg-white rounded-lg p-8 shadow-sm relative">
                    <div className="text-[#9b87f5] absolute -top-4 left-8 text-6xl">"</div>
                    <p className="italic text-gray-600 mb-6 relative z-10">
                      Занятия в "Гармонии" стали для меня настоящим спасением. Регулярная практика помогла мне справиться со стрессом на работе и улучшить осанку. Особенно ценю внимательность преподавателей к технике выполнения асан.
                    </p>
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Телеведущая, автор подкаста "В потоке"</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <CarouselItem>
                <div className="p-6">
                  <div className="bg-white rounded-lg p-8 shadow-sm relative">
                    <div className="text-[#9b87f5] absolute -top-4 left-8 text-6xl">"</div>
                    <p className="italic text-gray-600 mb-6 relative z-10">
                      После травмы спины врачи рекомендовали мне йогу, и я нашел "Гармонию". Благодаря индивидуальному подходу Натальи, я смог безопасно восстановиться и вернуться к активным тренировкам. Теперь йога - неотъемлемая часть моей жизни.
                    </p>
                    <div className="flex items-center">
                      <img
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Профессиональный спортсмен</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <CarouselItem>
                <div className="p-6">
                  <div className="bg-white rounded-lg p-8 shadow-sm relative">
                    <div className="text-[#9b87f5] absolute -top-4 left-8 text-6xl">"</div>
                    <p className="italic text-gray-600 mb-6 relative z-10">
                      Я пришла в "Гармонию" с целью справиться с хроническим стрессом и бессонницей. Курс медитации и йога-нидра с Андреем буквально изменили мою жизнь. Я научилась управлять эмоциями и наконец-то высыпаюсь. Рекомендую всем!
                    </p>
                    <div className="flex items-center">
                      <img
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Директор IT-компании</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-sm">
            <div className="text-center mb-8">
              <h2 className="font-montserrat text-3xl font-bold mb-4">Запишитесь на бесплатное занятие</h2>
              <p className="text-gray-600">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="message" placeholder="Ваши вопросы или пожелания" rows={4} />
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <label htmlFor="agreement" className="text-sm text-gray-600">
                  ...
                  <a href="#" className="text-[#9b87f5] hover:underline"> условия соглашения</a>
                </label>
              </div>

              <Button type="submit" className="w-full bg-[#9b87f5] hover:bg-[#8a76e4]" size="lg">
      ...
      <footer className="bg-[#1A1F2C] text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h3 className="font-montserrat font-semibold text-lg mb-4">Навигация</h3>
              <ul className="space-y-2">
                <li><a href="#about" className="text-gray-400 hover:text-[#9b87f5]">О школе</a></li>
                <li><a href="#teachers" className="text-gray-400 hover:text-[#9b87f5]">Преподаватели</a></li>
                <li><a href="#programs" className="text-gray-400 hover:text-[#9b87f5]">Программы</a></li>
                <li><a href="#testimonials" className="text-gray-400 hover:text-[#9b87f5]">Отзывы</a></li>
                <li><a href="#contact" className="text-gray-400 hover:text-[#9b87f5]">Контакты</a></li>
              </ul>
            </div>

            <div>
              <h3 className="font-montserrat font-semibold text-lg mb-4">Программы</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-[#9b87f5]">Хатха-йога</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[#9b87f5]">Аштанга-йога</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[#9b87f5]">Кундалини-йога</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[#9b87f5]">Йога для беременных</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[#9b87f5]">Детская йога</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <Icon name="MapPin" className="h-5 w-5 text-[#9b87f5] shrink-0 mt-0.5" />
                  <span className="text-gray-400">г. Москва, ул. Йоги, д. 108</span>
                </li>
                <li className="flex items-start gap-2">
                  <Icon name="Phone" className="h-5 w-5 text-[#9b87f5] shrink-0 mt-0.5" />
                  <span className="text-gray-400">+7 (495) 123-45-67</span>
                </li>
                <li className="flex items-start gap-2">
                  <Icon name="Mail" className="h-5 w-5 text-[#9b87f5] shrink-0 mt-0.5" />
                  <span className="text-gray-400">info@harmony-yoga.ru</span>
                </li>
                <li className="flex items-start gap-2">
                  <Icon name="Clock" className="h-5 w-5 text-[#9b87f5] shrink-0 mt-0.5" />
